...
//   }, [ stateArray, data.discount, data.step1value, data.step2Establishment, data.step2value1, data.step2value2, data.step2value2a, data.step2value3, data.step3EmiratesId, data.step3Medical, data.step2ApprovalFee, data.step2ImmigrationFee, data.step2SharjahFee, data.pro, data.visitingCard, data.letterHeadPad, data.investorVisa, data.employmentVisa, data.uidFee ])
...
// <SimpleDropdown labesl="Select Company" placeHolder="Select"  weight="bold" list={selectCompany} value={data.selectCompany} name='selectCompany' onChange={handleChange}
// />
//   </div> */}
...
// </div> */}
// <div className='my-8 flex flex-wrap gap-6 md:gap-5'>
//  <SelectAndInput value={data.step2value2a} list={selectVisaPartner} name='step2value2a' placeholder='Select' type='number' basicHandle={handleChange} handleChange={handleCustomSelect} label='Free Visa'/>
// </div>
// <div className='my-8 flex flex-wrap gap-6 md:gap-5'>
