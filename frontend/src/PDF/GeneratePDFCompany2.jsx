...
{/* step No 1 */}
      ...
      <Text style={{ fontSize: "8px", width: '18%', fontFamily: 'CustomFont500', color:"#111928"}}>Injaz Price</Text>
...
{/* 5 Page test */}
      ...
      <View>
       ...
       <View>
             <Image style={{marginHorizontal: 16, marginTop: 15,}} src="/page3InjazTop.png" />
           </View>
