...
const Quotation = () => {
  ...
  return (
    <div className="px-3 md:px-10">
      <h1 className="text-2xl font-medium mb-4 mt-6 text-textPrimary">
        Quotations
      </h1>
      ...
      <div className="flex flex-col gap-5 xl:gap-0 xl:flex-row xl:justify-between">
        {user?.role === "admin" && (
          <button
            className="bg-backgroundGreen500 max-w-60 text-base font-medium text-white px-6 py-3 rounded-lg"
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <select
            ...
            className="w-28 h-10 md:h-14 font-normal text-sm border-2 rounded-lg pr-3 pl-1"
          >
